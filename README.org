...
* TODO Generate md readme with TOC
* TODO Check theme options
* TODO begin DataFrames with basic review of lists and dictionaries; nb. , we did not talk about list insertion last time
...
#+BEGIN_SRC bash
pandoc -f gfm --toc --toc-depth=2 -s tmp.md -o README.md
#+END_SRC

*** Find and replace code block markers
#+BEGIN_EXAMPLE
