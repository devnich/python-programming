...
2. Cover numerical computing stuff (numpy)
3. Showcase SQL-like (dplyr-like) operations in Pandas, skipping some of the clunky basics if possible. Use R for Ecology examples
4. Realistic program control
