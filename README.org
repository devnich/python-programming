...
** TODO (Optional) Challenge: From Strings to Lists and Back
...
5. How can you change "carbon" to "Carbon"?

** TODO (Optional) Challenge: Locating the right module
...
*** Solutions:
1. You could try the ~random~ module.
...
* TODO Dictionaries - Wave FC numbers
